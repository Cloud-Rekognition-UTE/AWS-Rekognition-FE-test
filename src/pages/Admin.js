...
const Admin = () => {
    ...
    const onHandleChangeCollection = async(e)=>{
        e.preventDefault()
        try{
            let res = await axios.post('http://localhost:5000/api/collection',{
    ...
    const getDataCollection = async()=>{
        try{
            let result = await axios.get('http://localhost:5000/api/listCollection')
            console.log(result);
    ...
    const getDataList = async()=>{
        try{
            let result = await axios.get('http://localhost:5000/api/listingFace')
            console.log(result);
    ...
    const onHandleSubmitFace = async(e)=>{
        e.preventDefault()
        try{
            const res = await axios.post('http://localhost:5000/api/addIndex',{
    ...
    const deleteItemFace = async(item)=>{
        try{
            const res = await axios.post('http://localhost:5000/api/deleteFace',{
